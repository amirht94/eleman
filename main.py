...
def generate_schedule():
    ...
    if stream == "ریاضی" and grade == "دهم":
        main_subjects = ["هندسه", "فیزیک", "شیمی", "عمومی"]
    elif stream == "ریاضی" and grade == "یازدهم":
        main_subjects = ["حسابان", "آمار و احتمال", "هندسه", "فیزیک", "شیمی", "عمومی"]     
    elif stream == "ریاضی" and grade == "دوازدهم":
        main_subjects = ["گسسته", "حسابان", "هندسه", "فیزیک", "شیمی", "عمومی"]
        ...
        main_subjects = ["زیست", "شیمی", "ریاضی", "فیزیک", "عمومی"]  
        if student_type == "کنکوری":
